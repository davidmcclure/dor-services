...
Configuration is handled through the Dor::Config object:
  ...
  Dor::Config.configure do
    ...
    fedora.url = 'https://some.fedora.host/fedora'
    gsearch.url = 'http://some.gsearch.host/solr'
    ...
    # If using GeoMetadata
    geonetwork do
      service_root 'http://some.geonetwork.host/geonetwork'
    end
  end
...
- <b>4.3.0.rc6</b>
- <b>4.3.0.rc7</b>
- <b>4.3.0</b> Adds geoMetadata support
== Copyright
